...
class TestTranforms(BytecodeTestCase):
    ...
    @unittest.skip("PyRo compiler emits different comparison opcodes")
    ...
    @unittest.skip("Pyro does not optimize list contain")
    ...
    @unittest.skip("Pyro does not optimize list iteration")
