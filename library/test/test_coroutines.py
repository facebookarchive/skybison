...
class CoroutineTest(unittest.TestCase):
    ...
    def test_func_14(self):
        ...
        c = coro()
        c.send(None)
        # TODO(T71566677) - Restore regex match on exception text.
    ...
    # TODO(T71328424) Make copying/pickling wwork as appropriate.
    @unittest.skipIf(sys.implementation.name == "pyro", "T71328424")
...
@unittest.skipIf(
    ...
    "no need to support deprecated sys.get_coroutine_wrapper()")
