...
_imp__fix_co_filename(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyObject_TypeCheck(args[0], &PyCode_Type)) {
        _PyArg_BadArgument("_fix_co_filename", "argument 1", _PyType_Name(&PyCode_Type), args[0]);
        goto exit;
    }
...
/*[clinic end generated code: output=76fa2c69161d5194 input=a9049054013a1b77]*/
