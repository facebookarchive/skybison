...
property_init(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    fastargs = _PyArg_UnpackKeywords(argsbuf, nargs, kwargs, NULL, &_parser, 0, 4, 0, argsbuf);
    if (!fastargs) {
        goto exit;
    }
    if (!noptargs) {
...
/*[clinic end generated code: output=aa546eeb7d360ba9 input=a9049054013a1b77]*/
