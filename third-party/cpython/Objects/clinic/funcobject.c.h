...
func_new(PyTypeObject *type, PyObject *args, PyObject *kwargs)
{
    ...
    fastargs = _PyArg_UnpackKeywords(argsbuf, nargs, kwargs, NULL, &_parser, 2, 5, 0, argsbuf);
    if (!fastargs) {
        goto exit;
    }
    if (!PyObject_TypeCheck(fastargs[0], &PyCode_Type)) {
        _PyArg_BadArgument("function", "argument 'code'", _PyType_Name(&PyCode_Type), fastargs[0]);
        goto exit;
    }
...
/*[clinic end generated code: output=d71665f6ae35c28e input=a9049054013a1b77]*/
