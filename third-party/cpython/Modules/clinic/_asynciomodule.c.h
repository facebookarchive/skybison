...
_asyncio_Future___init__(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    Py_ssize_t copy_len = Py_MIN(nargs, 1);
...
_asyncio_Task___init__(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    fastargs = _PyArg_UnpackKeywords(argsbuf, nargs, kwargs, NULL, &_parser, 1, 1, 0, argsbuf);
    if (!fastargs) {
        goto exit;
    }
    coro = fastargs[0];
...
/*[clinic end generated code: output=1f13ed8bf2788b3e input=a9049054013a1b77]*/
