...
_curses_panel_panel_replace(PyCursesPanelObject *self, PyObject *arg)
{
    ...
    if (!PyObject_TypeCheck(arg, &PyCursesWindow_Type)) {
        _PyArg_BadArgument("replace", "argument", _PyType_Name(&PyCursesWindow_Type), arg);
        goto exit;
    }
...
_curses_panel_new_panel(PyObject *module, PyObject *arg)
{
    ...
    if (!PyObject_TypeCheck(arg, &PyCursesWindow_Type)) {
        _PyArg_BadArgument("new_panel", "argument", _PyType_Name(&PyCursesWindow_Type), arg);
        goto exit;
    }
    win = (PyCursesWindowObject *)arg;
...
/*[clinic end generated code: output=08b9e3965839caa3 input=a9049054013a1b77]*/
