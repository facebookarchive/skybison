...
ExtensionTypeInitializer kExtensionTypeInitializers[] = {
    {PyType_Type_Init},  {PyBaseObject_Type_Init}, {PyBool_Type_Init},
    {PyDict_Type_Init},  {PyFloat_Type_Init},      {PyList_Type_Init},
    {PyLong_Type_Init},  {PyModule_Type_Init},     {PyNone_Type_Init},
    {PyTuple_Type_Init}, {PyUnicode_Type_Init},    {nullptr},
};
