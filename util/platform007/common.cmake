...
set(NCURSES_INCLUDE_DIRS ${NCURSES_PREFIX}/include)
...
set(READLINE_INCLUDE_DIRS ${READLINE_PREFIX}/include)
set(READLINE_LIBRARY_DIRS ${READLINE_PREFIX}/lib)
set(READLINE_LIBRARIES ${READLINE_PREFIX}/lib/libreadline.so)
