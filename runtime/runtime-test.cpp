...
TEST(RuntimeTest, StringFormat1) {
  Runtime runtime;
  HandleScope scope;
  Thread* thread = Thread::currentThread();
...
TEST(RuntimeTest, StringFormat2) {
  Runtime runtime;
  HandleScope scope;
  Thread* thread = Thread::currentThread();
...
TEST(RuntimeTest, StringFormatMixed) {
  Runtime runtime;
  HandleScope scope;
  Thread* thread = Thread::currentThread();
...
TEST(RuntimeTest, StringFormatMixed2) {
  Runtime runtime;
  HandleScope scope;
  Thread* thread = Thread::currentThread();
...
TEST(RuntimeTest, StringFormatMalformed) {
  Runtime runtime;
  HandleScope scope;
  Thread* thread = Thread::currentThread();
...
TEST(RuntimeTest, StringFormatMismatch) {
  Runtime runtime;
  HandleScope scope;
  Thread* thread = Thread::currentThread();
...
TEST(RuntimeTest, creatingApiHandles) {
  ...
  ApiHandle* integer_handle = runtime.asApiHandle(*obj);
...
TEST(RuntimeTest, borrowedApiHandles) {
  Runtime runtime;
  HandleScope scope;

  // Create a borrowed handle
  Handle<Object> obj(&scope, runtime.newInteger(15));
  ApiHandle* borrowed_handle = runtime.asBorrowedApiHandle(*obj);
  ...
  ApiHandle* integer_handle = runtime.asApiHandle(*obj2);
  ...
  ApiHandle* integer_handle2 = runtime.asBorrowedApiHandle(*obj);
