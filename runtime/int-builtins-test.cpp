...
TEST_F(IntBuiltinsTest, DunderCeilAliasesDunderInt) {
  ...
  Object dint_name(&scope, runtime_.newStrFromCStr("__int__"));
  Object dint_obj(&scope, runtime_.typeDictAt(thread, dict, dint_name));
...
TEST_F(IntBuiltinsTest, DunderStrAliasesDunderRepr) {
  ...
  Object repr_name(&scope, runtime_.newStrFromCStr("__repr__"));
  Object repr_obj(&scope, runtime_.typeDictAt(thread, dict, repr_name));
...
TEST_F(IntBuiltinsTest, ConjugateAliasesDunderInt) {
  ...
  Object conjugate_obj(&scope,
                       runtime_.typeDictAt(thread, dict, conjugate_name));
