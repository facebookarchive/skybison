...
TEST_F(MarshalReaderTest, ReadObjectCode) {
  ...
  const byte bytes[] =
      ...
      "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x40\x00\x00"
      "\x00\x73\x04\x00\x00\x00\x64\x00\x53\x00\x29\x01\x4E\xA9\x00\x72\x01\x00"
      "\x00\x00\x72\x01\x00\x00\x00\x72\x01\x00\x00\x00\xFA\x07\x70\x61\x73\x73"
      "\x2E\x70\x79\xDA\x08\x3C\x6D\x6F\x64\x75\x6C\x65\x3E\x01\x00\x00\x00\x73"
      "\x00\x00\x00\x00";
  Marshal::Reader reader(&scope, thread_, bytes);
  ...
  EXPECT_EQ(code.posonlyargcount(), 0);
